  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
					...
					<li class="treeview <?php if( ($cur_page == 'order_reports.php') || ($cur_page == 'customer_reports.php')) {echo 'active';} ?>">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="customer_reports.php"><i class="fa fa-circle-o"></i> Customer Reports</a></li>
