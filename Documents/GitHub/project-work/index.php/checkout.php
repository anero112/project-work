                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo 'GHS'; ?><?php echo $arr_cart_p_current_price[$i]; ?></td>
                            ...
                            <td class="text-right">
                                ...
                                ?>
                                <?php echo 'GHS'; ?><?php echo $row_total_price; ?>
                            </td>
                        </tr>
                        <?php endfor; ?>           
                        <tr>
                            <th colspan="7" class="total-text"><?php echo LANG_VALUE_81; ?></th>
                            <th class="total-amount"><?php echo 'GHS'; ?><?php echo $table_total_price; ?></th>
                        </tr>
                        <?php
                        ...
                        <tr>
                            ...
                            <td class="total-amount"><?php echo 'GHS'; ?><?php echo $shipping_cost; ?></td>
                        </tr>
                        <tr>
                            ...
                            <th class="total-amount">
                                ...
                                ?>
                                <?php echo 'GHS'; ?><?php echo $final_total; ?>
                            </th>
                        </tr>
                    </table> 
                </div>
